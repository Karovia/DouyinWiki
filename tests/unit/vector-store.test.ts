...
import { embeddings, chunks } from '../../src/db/schema';
...
describe('SQLiteVectorStore', () => {
  ...
  it('should upsert and search embeddings', async () => {
    ...
    await db.insert(videos).values({
      ...
      workspaceId,
      platform: 'douyin',
      shareUrl: 'https://www.douyin.com/video/test',
      normalizedUrlHash: 'test-hash',
    });
  ...
  it('should respect contentType filter', async () => {
    ...
    await db.insert(videos).values({
      ...
      workspaceId,
      platform: 'douyin',
      shareUrl: 'https://www.douyin.com/video/test2',
      normalizedUrlHash: 'test-hash-2',
    });
